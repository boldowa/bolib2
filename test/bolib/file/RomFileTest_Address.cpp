...
TEST(RomFile_Address, LoROM)
{
	...
	LONGS_EQUAL(ROMADDRESS_NULL, target->Snes2PcAdr(target, 0x708000));	/**< GamePakRAM */
	LONGS_EQUAL(ROMADDRESS_NULL, target->Snes2PcAdr(target, 0x7dffff));	/**< GamePakRAM */
 ...
 */
TEST(RomFile_Address, SA1ROM_Snes2Pc_mbon)
{
	SA1AdrInfo sa1inf;
	...
	sa1inf.mbits[0] = sa1inf.mbits[1] = sa1inf.mbits[2] = sa1inf.mbits[3] = true;
	sa1inf.useHiRomMap	= false;	/**< Use LoROM Address conversion mode */
	sa1inf.slots[0]		= 0x0;		/**< Slot[0] : PC $00:0000 - $0f:ffff */
	sa1inf.slots[1]		= 0x1;		/**< Slot[1] : PC $10:0000 - $1f:ffff */
	sa1inf.slots[2]		= 0x2;		/**< Slot[2] : PC $20:0000 - $2f:ffff */
	sa1inf.slots[3]		= 0x3;		/**< Slot[3] : PC $30:0000 - $3f:ffff */
	...
	sa1inf.slots[0]		= 0x3;		/**< Slot[0] : PC $30:0000 - $3f:ffff */
	sa1inf.slots[1]		= 0x2;		/**< Slot[1] : PC $20:0000 - $2f:ffff */
	sa1inf.slots[2]		= 0x1;		/**< Slot[2] : PC $10:0000 - $1f:ffff */
	sa1inf.slots[3]		= 0x0;		/**< Slot[3] : PC $00:0000 - $0f:ffff */
	target->SetSA1Info(target, sa1inf);
	...
	/*--- Snes2Pc LoROM-like ---*/
	LONGS_EQUAL(0x200000, target->Snes2PcAdr(target, 0x008000));		/**< Slot[0] min */
	LONGS_EQUAL(0x2fffff, target->Snes2PcAdr(target, 0x1fffff));		/**< Slot[0] max-size */

	/*--- Snes2Pc HiROM-like ---*/
	LONGS_EQUAL(0x200000, target->Snes2PcAdr(target, 0xc00000));		/**< Slot[0] min */
	LONGS_EQUAL(0x2fffff, target->Snes2PcAdr(target, 0xcfffff));		/**< Slot[0] max-size */
 ...
 * Check SA1ROM Snes2PC Address conversion
 */
TEST(RomFile_Address, SA1ROM_Snes2Pc_mboff)
{
	SA1AdrInfo sa1inf;
	...
	/* Set SA1 address conversion mode */
	sa1inf.mbits[0] = sa1inf.mbits[1] = sa1inf.mbits[2] = sa1inf.mbits[3] = false;
	sa1inf.useHiRomMap	= false;	/**< Use LoROM Address conversion mode */
	sa1inf.slots[0]		= 0x0;		/**< Slot[0] : PC $00:0000 - $0f:ffff */
	sa1inf.slots[1]		= 0x1;		/**< Slot[1] : PC $10:0000 - $1f:ffff */
	sa1inf.slots[2]		= 0x2;		/**< Slot[2] : PC $20:0000 - $2f:ffff */
	...
	/*--- Snes2Pc LoROM-like ---*/
	LONGS_EQUAL(0x000000, target->Snes2PcAdr(target, 0x008000));		/**< Slot[0] min */
	LONGS_EQUAL(0x0fffff, target->Snes2PcAdr(target, 0x1fffff));		/**< Slot[0] max-size */
 ...
 */
TEST(RomFile_Address, SA1ROM_Pc2Snes_mbon)
{
	SA1AdrInfo sa1inf;
	...
	/*************** overflow check ***************/
	sa1inf.slots[0]		= 0x2;		/**< Slot[0] : PC $50:0000 - $5f:ffff */

	/*--- Snes2Pc LoROM-like ---*/
	sa1inf.useHiRomMap	= false;	/**< Use LoROM Address conversion mode */
	target->SetSA1Info(target, sa1inf);
	LONGS_EQUAL(0x008000, target->Pc2SnesAdr(target, 0x200000));		/**< Slot[0] min */
	LONGS_EQUAL(0x1fffff, target->Pc2SnesAdr(target, 0x2fffff));		/**< Slot[0] max-size */
	/*LONGS_EQUAL(ROMADDRESS_NULL, target->Pc2SnesAdr(target, 0x400000));*/	/**< overflow */

	/*--- Snes2Pc HiROM-like ---*/
	sa1inf.useHiRomMap	= true; 	/**< Use HiROM Address conversion mode */
	target->SetSA1Info(target, sa1inf);
	LONGS_EQUAL(0xc00000, target->Pc2SnesAdr(target, 0x200000));		/**< Slot[0] min */
	LONGS_EQUAL(0xcfffff, target->Pc2SnesAdr(target, 0x2fffff));		/**< Slot[0] max-size */
	LONGS_EQUAL(ROMADDRESS_NULL, target->Pc2SnesAdr(target, 0x400000));	/**< overflow */
}
 ...
 * Check SA1ROM PC2Snes Address conversion
 */
TEST(RomFile_Address, SA1ROM_Pc2Snes_mboff)
{
	SA1AdrInfo sa1inf;
	...
	target->SetSA1Info(target, sa1inf);
	LONGS_EQUAL(0x008000, target->Pc2SnesAdr(target, 0x000000));		/**< Slot[0] min */
	LONGS_EQUAL(0x1fffff, target->Pc2SnesAdr(target, 0x0fffff));		/**< Slot[0] max-size */
	/*LONGS_EQUAL(ROMADDRESS_NULL, target->Pc2SnesAdr(target, 0x400000));*/	/**< overflow */
